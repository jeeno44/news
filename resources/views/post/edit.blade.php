            ...
            <div class="col-6 offset-2">
                ...
                <form method="post" action="/post/{{ $post->id }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="subheadline" name="subheadline" value="{{ $post->subheadline }}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="post" rows="3" name="post">{{ $post->post }}</textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="status" name="import_id">
                            @foreach($imps as $imp)
